    ...
    public void unesiZaposlenog(ActionEvent event){
        ...
        dugme.addActionListener((ActionEvent e1) -> {
            ...
            if(ime.length() > maxDuzinaImena || ime.length() < 1){
                JOptionPane.showMessageDialog(null, "Ime moze biti najvise " + maxDuzinaImena + " slova, najmanje 1 slovo.");
                return;
            }
    ...
    public void izmeniNaOsnovuId(ActionEvent event){
        ...
        dugmeIzmeni.addActionListener((ActionEvent e1) -> {
            ...
            if (checkBoxIme.isSelected()){
                ime = tfIme.getText();
                if(ime.length() > maxDuzinaImena || ime.length() < 1){
                    JOptionPane.showMessageDialog(null, "Ime moze biti najduze " + maxDuzinaImena + " karaktera, a najmanje 1");
                    return;
                }
            }
            ...
            if(checkBoxGodine.isSelected()){
                try{
                    ...
                    if(godine < 0){
                        JOptionPane.showMessageDialog(null, "Godine moraju biti vece od 0.");
                        return;
                    }
                } catch(Exception e){
                    e.printStackTrace();
            ...
            switch(daLiJeSveProsloKakoTreba){
                ...
                case BazaPodataka.NEISPRAVAN_ID:{
                    JOptionPane.showMessageDialog(null, "Neispravan id");
                    break;
                }
                case BazaPodataka.HIBERNATE_EXCEPTION:{
                    JOptionPane.showMessageDialog(null, "Dogodila se greska prilikom konekcije sa bazom.");
                    break;
                }
                default: {}
            }
